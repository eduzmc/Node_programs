...
#define NOME_DA_REDE "Eduardo 2.4G"
#define SENHA_DA_REDE "23247506zmc"
...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    const char* site = "http://viacep.com.br/ws/09270530/json/";
    tratarRequisicaoGetHttp(site);
    //delay(1000);
    //tratarRequisicaoGetHttp("http://192.168.0.30:1880/ola-nome?nome=Eduardo");
  }
